/*
    -- MAGMA (version 1.1) --
       ...
       @generated from clmagmablas/ztranspose.cl, normal z -> d, Tue Jun 18 16:42:02 2019
...
dtranspose_device(
    ...
    __global const double *A, magma_int_t lda,
    __global double *AT,      magma_int_t ldat);
...
void dtranspose_kernel(
    ...
    __global double *AT, unsigned long AT_offset,      magma_int_t ldat)
{
    A += A_offset;
    AT += AT_offset;
