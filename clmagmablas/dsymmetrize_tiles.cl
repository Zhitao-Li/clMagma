/*
    -- MAGMA (version 1.1) --
       ...
       @generated from clmagmablas/zsymmetrize_tiles.cl, normal z -> d, Tue Jun 18 16:14:14 2019

       auto-converted from dsymmetrize_tiles.cu
       @author Mark Gates
*/
#include "kernels_header.h"
#include "dsymmetrize_tiles.h"
...
*/
__kernel void
dsymmetrize_tiles_lower( magma_int_t m, __global double *dA, unsigned long dA_offset, magma_int_t ldda, magma_int_t mstride, magma_int_t nstride )
{
    dA += dA_offset;
...
__kernel void
dsymmetrize_tiles_upper( magma_int_t m, __global double *dA, unsigned long dA_offset, magma_int_t ldda, magma_int_t mstride, magma_int_t nstride )
{
    dA += dA_offset;
