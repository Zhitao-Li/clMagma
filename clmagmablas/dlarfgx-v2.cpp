/*
    -- clMAGMA (version 1.0) --
       ...
       @generated from clmagmablas/zlarfgx-v2.cpp, normal z -> d, Tue Jun 18 16:14:19 2019
    ...
    magma_queue_t queue)
{
    ...
    kernel = g_runtime.get_kernel( "magma_dlarfgx_gpu_kernel" );
    if ( ! kernel ) {
    ...
    ciErrNum |= clSetKernelArg( kernel, nn++, sizeof(magmaDouble_ptr), (void*)&dx0 );
    ciErrNum |= clSetKernelArg( kernel, nn++, sizeof(int), (void*)&dx0_offset     );
    ciErrNum |= clSetKernelArg( kernel, nn++, sizeof(magmaDouble_ptr), (void*)&dx   );
    ciErrNum |= clSetKernelArg( kernel, nn++, sizeof(int), (void*)&dx_offset );
    ciErrNum |= clSetKernelArg( kernel, nn++, sizeof(magmaDouble_ptr), (void*)&dtau     );
    ...
    magma_queue_t queue)
{
    ...
    if (i == 0) {
        ...
        cl_int ciErrNum;                // Error code var
        cl_kernel kernel=NULL;
        kernel = g_runtime.get_kernel( "magma_dgemv_kernel3" );     // in dlarfbx.cl
        ...
        int nn = 0;
        ciErrNum  = clSetKernelArg( kernel, nn++, sizeof(int), (void*)&n   );
        ciErrNum |= clSetKernelArg( kernel, nn++, sizeof(magmaDouble_ptr), (void*)&V );
        ciErrNum |= clSetKernelArg( kernel, nn++, sizeof(int), (void*)&V_offset     );
        ciErrNum |= clSetKernelArg( kernel, nn++, sizeof(int), (void*)&ldv   );
        ciErrNum |= clSetKernelArg( kernel, nn++, sizeof(magmaDouble_ptr), (void*)&dx0 );
        ciErrNum |= clSetKernelArg( kernel, nn++, sizeof(int), (void*)&dx0_offset     );
        ciErrNum |= clSetKernelArg( kernel, nn++, sizeof(magmaDouble_ptr), (void*)&work );
        ...
        kernel = g_runtime.get_kernel( "magma_dtrmv_kernel2" );         // in dlarfx.cl
        ...
        nn = 0;
        ciErrNum  = clSetKernelArg( kernel, nn++, sizeof(magmaDouble_ptr), (void*)&T   );
        ...
        ciErrNum |= clSetKernelArg( kernel, nn++, sizeof(magmaDouble_ptr), (void*)&T1 );
