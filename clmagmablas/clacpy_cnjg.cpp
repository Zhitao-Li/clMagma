/*
    -- MAGMA (version 1.1) --
       ...
       @generated from clmagmablas/zlacpy_cnjg.cpp, normal z -> c, Tue Jun 18 16:14:18 2019
...
magmablas_clacpy_cnjg(
    magma_int_t n,
    magmaFloatComplex_ptr dA1, size_t dA1_offset, magma_int_t lda1, 
    magmaFloatComplex_ptr dA2, size_t dA2_offset, magma_int_t lda2,
    magma_queue_t queue )
{
    cl_kernel kernel;
    cl_int err;
    ...
    blocks[0] *= threads[0];
    kernel = g_runtime.get_kernel( "clacpy_cnjg_kernel" );
    if ( kernel != NULL ) {
        err = 0;
        arg = 0;
