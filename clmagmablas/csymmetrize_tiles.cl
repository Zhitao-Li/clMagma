/*
    -- MAGMA (version 1.1) --
       ...
       @generated from clmagmablas/zsymmetrize_tiles.cl, normal z -> c, Tue Jun 18 16:14:14 2019
...
*/
__kernel void
csymmetrize_tiles_lower( magma_int_t m, __global magmaFloatComplex *dA, unsigned long dA_offset, magma_int_t ldda, magma_int_t mstride, magma_int_t nstride )
{
    dA += dA_offset;
...
__kernel void
csymmetrize_tiles_upper( magma_int_t m, __global magmaFloatComplex *dA, unsigned long dA_offset, magma_int_t ldda, magma_int_t mstride, magma_int_t nstride )
{
    dA += dA_offset;
