/*
    -- MAGMA (version 1.1) --
       ...
       @generated from clmagmablas/ztranspose_inplace.cl, normal z -> d, Tue Jun 18 16:14:14 2019
...
__kernel void dtranspose_inplace_odd(
    magma_int_t n,
    __global double *matrix, unsigned long matrix_offset, magma_int_t lda )
{
...
__kernel void dtranspose_inplace_even(
    magma_int_t n,
    __global double *matrix, unsigned long matrix_offset, magma_int_t lda )
{
    matrix += matrix_offset;
