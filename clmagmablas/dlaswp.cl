/*
    -- MAGMA (version 1.1) --
       ...
       @generated from clmagmablas/zlaswp.cl, normal z -> d, Tue Jun 18 16:14:14 2019
...
__kernel void dlaswp_kernel(
    magma_int_t n,
    __global double *dAT, unsigned long dAT_offset, magma_int_t ldda,
...
__kernel void dlaswpx_kernel(
    magma_int_t n,
    __global double *dA, unsigned long dA_offset, magma_int_t ldx, magma_int_t ldy,
    dlaswp_params_t params )
{
    dA += dA_offset;
