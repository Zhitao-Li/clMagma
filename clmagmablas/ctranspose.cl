/*
    -- MAGMA (version 1.1) --
       ...
       @generated from clmagmablas/ztranspose.cl, normal z -> c, Tue Jun 18 16:42:02 2019
...
ctranspose_device(
    ...
    __global const magmaFloatComplex *A, magma_int_t lda,
    __global magmaFloatComplex *AT,      magma_int_t ldat);
...
void ctranspose_kernel(
    magma_int_t m, magma_int_t n,
    __global const magmaFloatComplex *A, unsigned long A_offset, magma_int_t lda,
    __global magmaFloatComplex *AT, unsigned long AT_offset,      magma_int_t ldat)
{
    A += A_offset;
    AT += AT_offset;
