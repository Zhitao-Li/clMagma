/*
    -- clMAGMA (version 1.0) --
       ...
       @generated from clmagmablas/zgemm_reduce.cl, normal z -> s, Tue Jun 18 16:14:14 2019
*/
...
void magma_ssum_reduce3d( int n, int j, int k, int i, __local float* x );  // prototype to suppress compiler warning
void magma_ssum_reduce3d( int n, int j, int k, int i, __local float* x )
{
                                   ...
                                   __global float *d_C, int d_C_offset, int ldc)
{
    ...
    */
    ...
    magma_ssum_reduce3d( BLK_K, get_local_id(1), get_local_id(2), i, (__local float*) sum );
