/*
    -- MAGMA (version 1.1) --
       ...
       @generated from clmagmablas/zsymmetrize.cl, normal z -> s, Tue Jun 18 16:14:14 2019

       auto-converted from ssymmetrize.cu
       @author Mark Gates
*/
#include "kernels_header.h"
#include "ssymmetrize.h"
...
*/
__kernel void
ssymmetrize_lower( magma_int_t m, __global float *dA, unsigned long dA_offset, magma_int_t ldda )
{
    dA += dA_offset;
...
__kernel void
ssymmetrize_upper( magma_int_t m, __global float *dA, unsigned long dA_offset, magma_int_t ldda )
{
    dA += dA_offset;
