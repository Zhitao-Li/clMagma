/*
    -- MAGMA (version 1.1) --
       ...
       @generated from clmagmablas/zlaswp.cl, normal z -> c, Tue Jun 18 16:14:14 2019
...
__kernel void claswp_kernel(
    magma_int_t n,
    __global magmaFloatComplex *dAT, unsigned long dAT_offset, magma_int_t ldda,
...
__kernel void claswpx_kernel(
    magma_int_t n,
    __global magmaFloatComplex *dA, unsigned long dA_offset, magma_int_t ldx, magma_int_t ldy,
    claswp_params_t params )
{
    dA += dA_offset;
