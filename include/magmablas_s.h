/*
    -- MAGMA (version 1.1) --
       ...
       @generated from include/magmablas_z.h, normal z -> s, Tue Jun 18 16:14:13 2019
*/
...
magmablas_slarfg(
    magma_int_t n,
    magmaFloat_ptr dalpha, size_t dalpha_offset,
...
magmablas_slascl_diag(
    ...
    const magmaFloat_ptr dD, size_t dD_offset, magma_int_t lddd,
    magmaFloat_ptr dA, size_t dA_offset, magma_int_t ldda,
    magma_queue_t queue,
    magma_int_t *info );
