 ...
 *     @date
 *
 * @generated from testing/testing_zgemm_reduce.cpp, normal z -> c, Tue Jun 18 16:14:24 2019
 *
 **/
    ...
    for( i=istart; i<iend; i = (int)(i*1.25) ) {
        for( int cnt = 0; cnt < count; ++cnt ) {
            ...
            if ( lapack ) {
                ...
                blasf77_cgemm( lapack_trans_const(transA), lapack_trans_const(transB), &M, &N, &K,
                               &alpha, h_A, &lda,
                                       h_B, &ldb,
                               &beta,  h_C, &ldc );
