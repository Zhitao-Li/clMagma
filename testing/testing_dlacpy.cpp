/*
    -- MAGMA (version 1.1) --
       ...
       @generated from testing/testing_zlacpy.cpp, normal z -> d, Tue Jun 18 16:14:24 2019
       @author Mark Gates
*/
      ...
      for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.verbose ) {
                ...
                printf( "dB=" );  magma_dprint_gpu( M, N, d_B, 0, lddb, opts.queue );
            }
            
            /* =====================================================================
               Check the result
               =================================================================== */
            magma_dgetmatrix( M, N, d_B, 0, lddb, h_R, lda, opts.queue );
