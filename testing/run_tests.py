...
##	('testing_z_cublas_v2',            '-c',  n,    'cublas only'),
	...
	# no-trans/conj-trans; there are other combinations with trans
	('testing_zgemm_reduce',   '-l -NN         -c',  mnk,  'what sizes to test?'),
	('testing_zgemm_reduce',   '-l -NC         -c',  mnk,  'what sizes to test?'),
	('testing_zgemm_reduce',   '-l -CN         -c',  mnk,  'what sizes to test?'),
	('testing_zgemm_reduce',   '-l -CC         -c',  mnk,  'what sizes to test?'),
...
chol = (
	...
	('testing_zpotrf_gpu',       '--version 2 -L   -c2',  n,    ''),
	('testing_zpotrf_gpu',       '--version 2 -U   -c2',  n,    ''),
	
	('testing_zpotrf_msub',      '-L   -c2',  n,    ''),
	('testing_zpotrf_msub',      '-U   -c2',  n,    ''),
...
##	('testing_zgeqr2_gpu',             '-c',  mn,   ''),
	...
	('testing_zgeqrf_msub', '--version 1 -c2', mn,   ''),
	('testing_zgeqrf_msub', '--version 2 -c2', mn,   ''),
	('testing_zgeqrf_msub', '--version 3 -c2', mn,   ''),
...
##	('testing_zheevd_gpu',      '-U -JV -c',  n,    ''),
	...
	# lower/upper, version 1 (clblas_hemv), no version 2 in clMAGMA
