/*
    -- clMAGMA (version 1.1) --
       ...
       @generated from testing/testing_zgeqrf_gpu.cpp, normal z -> c, Tue Jun 18 16:14:26 2019
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.version == 2 ) {
                ...
                if ( opts.version == 1 ) {
                    ...
                    magma_cgeqrf3_gpu( M, N, d_A, 0, ldda, tau, dT, 0, opts.queue, &info );
                }
                #endif
                else {
            ...
            if ( opts.check && opts.version == 2 ) {
                ...
                if ( opts.version == 1 ) {
                    ...
                    magma_cgeqrs_gpu( M, N, 1,
                                      d_A, 0, ldda, tau, dT, 0,
                                      d_B, 0, M, hwork, lwork2, opts.queue, &info );
                    if (info != 0)
