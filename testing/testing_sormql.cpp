/*
    -- MAGMA (version 1.1) --
       ...
       @author Mark Gates
       @generated from testing/testing_zunmql.cpp, normal z -> s, Tue Jun 18 16:14:26 2019
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
      ...
      for( int itran = 0; itran < 2; ++itran ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_sgeqlf( mm, k, A, lda, tau, W, lwork_max, opts.queues2, &info );
            if (info != 0)
            ...
            magma_sormql( side[iside], trans[itran],
                          m, n, k,
                          A, lda, tau, R, ldc, W, lwork, opts.queue, &info );
            if (info != 0)
