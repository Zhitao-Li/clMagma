/*
    -- clMAGMA (version 1.1) --
       ...
       @generated from testing/testing_zgetrf_msub.cpp, normal z -> s, Tue Jun 18 16:14:25 2019
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv)
{
    ...
    magma_int_t dev, j, k, ngpu, nsub, n_local, nb, nk, maxm;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.transA == MagmaNoTrans ) {
                ...
                ldda = magma_roundup( ldda, 32 );  // multiple of 32 by default /* make it a multiple of 32 */
