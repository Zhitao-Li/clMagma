/*
    -- MAGMA (version 1.1) --
       ...
       @generated from testing/testing_zlange.cpp, normal z -> c, Tue Jun 18 16:14:24 2019
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
      for( int inorm = 0; inorm < 3; ++inorm ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            norm_magma = magmablas_clange( norm[inorm], M, N, d_A, 0, ldda, d_work, 0, lwork, opts.queue );
