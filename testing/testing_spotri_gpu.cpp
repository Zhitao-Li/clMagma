/*
    -- clMAGMA (version 1.1) --
       ...
       @generated from testing/testing_zpotri_gpu.cpp, normal z -> s, Tue Jun 18 16:14:25 2019
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
        ...
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if ( opts.lapack ) {
                ...
                /* =====================================================================
                   ...
                   =================================================================== */
                magma_sgetmatrix( N, N, d_A, 0, ldda, h_R, lda, opts.queue );
                norm  = lapackf77_slange("f", &N, &N, h_A, &lda, work);
                blasf77_saxpy(&n2, &c_neg_one, h_A, &ione, h_R, &ione);
                error = lapackf77_slange("f", &N, &N, h_R, &lda, work) / norm;
