/*
    -- MAGMA (version 1.1) --
       ...
       @generated from testing/testing_zgeadd.cpp, normal z -> s, Tue Jun 18 16:14:24 2019
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_ssetmatrix( M, N, h_B, lda, d_B, 0, ldda, opts.queue );
            
            //magmablasSetKernelStream( opts.queue );
            gpu_time = magma_sync_wtime( opts.queue );
            magmablas_sgeadd( M, N, alpha, d_A, 0, ldda, d_B, 0, ldda, opts.queue );
            ...
            /* =====================================================================
               Check result
               =================================================================== */
            magma_sgetmatrix( M, N, d_B, 0, ldda, h_A, lda, opts.queue );
