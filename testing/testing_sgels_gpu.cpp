/*
    -- MAGMA (version 1.1) --
       ...
       @generated from testing/testing_zgels_gpu.cpp, normal z -> s, Tue Jun 18 16:14:25 2019
...
int main( int argc, char** argv )
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_ssetmatrix( M, nrhs, h_B, ldb, d_B, 0, lddb, opts.queue );
            
            gpu_time = magma_wtime();
            magma_sgels_gpu( MagmaNoTrans, M, N, nrhs, d_A, 0, ldda,
                             d_B, 0, lddb, h_work, lworkgpu, opts.queue, &info );
