/*
    -- MAGMA (version 1.1) --
       ...
       @generated from testing/testing_zher2k.cpp, normal z -> s, Tue Jun 18 16:14:24 2019
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_ssetmatrix( An, Ak, h_A, lda, d_A, 0, ldda, opts.queue );
            magma_ssetmatrix( Bn, Bk, h_B, ldb, d_B, 0, lddb, opts.queue );
            magma_ssetmatrix( N, N, h_C, ldc, d_C, 0, lddc, opts.queue );
            ...
            magma_sgetmatrix( N, N, d_C, 0, lddc, h_Ccublas, ldc, opts.queue );
