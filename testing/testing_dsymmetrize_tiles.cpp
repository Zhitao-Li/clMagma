/*
    -- MAGMA (version 1.1) --
       ...
       @generated from testing/testing_zsymmetrize_tiles.cpp, normal z -> d, Tue Jun 18 16:14:25 2019
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magmablas_dsymmetrize_tiles( opts.uplo, nb, d_A, 0, ldda, ntile, mstride, nstride, opts.queue );
