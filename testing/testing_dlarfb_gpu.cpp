/*
    -- MAGMA (version 1.1) --
       ...
       @author Mark Gates
       @generated from testing/testing_zlarfb_gpu.cpp, normal z -> d, Tue Jun 18 16:14:26 2019
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
      ...
      for( int itran = 0; itran < 2; ++itran ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_dsetmatrix( M,   N,  C, ldc, dC, 0, ldc, opts.queue );
            magma_dsetmatrix( ldv, nv, V, ldv, dV, 0, ldv, opts.queue );
            magma_dsetmatrix( K,   K,  T, ldt, dT, 0, ldt, opts.queue );
            ...
            magma_dlarfb_gpu( side[iside], trans[itran], direct[idir], storev[istor],
                              ...
                              dC, 0, ldc,
                              dW, 0, ldw, opts.queue );
            magma_dgetmatrix( M, N, dC, 0, ldc, R, ldc, opts.queue );
