/*
    -- MAGMA (version 1.1) --
       ...
       @generated from testing/testing_ztrmv.cpp, normal z -> c, Tue Jun 18 16:14:24 2019
...
int main( int argc, char** argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_csetvector( N, h_x, 1, d_x, 0, 1, opts.queue );
            ...
            magma_cgetvector( N, d_x, 0, 1, h_xcublas, 1, opts.queue );
