/*
    -- MAGMA (version 1.1) --
       ...
       @generated from testing/testing_ztrsm.cpp, normal z -> s, Tue Jun 18 16:14:24 2019
...
int main( int argc, char** argv)
{
    ...
    {
        skip_clblas = true;
        fprintf( stderr, "\nWARNING: skipping clblasStrsm( %s, %s, %s, %s ) due to errors.\n\n",
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_ssetmatrix( Ak, Ak, h_A, lda, d_A, 0, ldda, opts.queue );
