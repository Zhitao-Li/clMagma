/*
    -- clMAGMA (version 1.1) --
       ...
       @generated from testing/testing_zgetrf_mgpu.cpp, normal z -> d, Tue Jun 18 16:14:25 2019
       @author Mark Gates
*/
// includes, system
#include <stdlib.h>
...
int main( int argc, char** argv )
{
    ...
    magma_int_t *ipiv;
    magma_int_t M, N, n2, lda, ldda, n_local;
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_dgetrf_mgpu( ngpu, M, N, d_lA, 0, ldda, ipiv, queues2, &info );
