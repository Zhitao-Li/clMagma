/*
    -- MAGMA (version 1.1) --
       ...
       @author Mark Gates
       @generated from testing/testing_zunmbr.cpp, normal z -> d, Tue Jun 18 16:14:26 2019
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
      ...
      for( int itran = 0; itran < 2; ++itran ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_dgebrd( mm, nn, A, lda, d, e, tauq, taup, work, lwork_max, opts.queue, &info );
            if (info != 0)
            ...
            magma_dormbr( vect[ivect], side[iside], trans[itran],
                          m, n, k,
                          A, lda, tau, R, ldc, work, lwork, opts.queue, &info );
            if (info != 0)
