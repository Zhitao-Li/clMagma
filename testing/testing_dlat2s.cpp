/*
    -- MAGMA (version 1.1) --
       ...
       @author Mark Gates
       @generated from testing/testing_zlat2c.cpp, mixed zc -> ds, Tue Jun 18 16:14:24 2019
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
    ...
    for( int iuplo = 0; iuplo < 2; ++iuplo ) {
      for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magma_dsetmatrix( n, n, A,  lda, dA,  0, ldda, opts.queue );
            magma_ssetmatrix( n, n, SA, lda, dSA, 0, ldda, opts.queue );
            ...
            magmablas_dlat2s( uplo[iuplo], n, dA, 0, ldda, dSA, 0, ldda, opts.queue, &info );
            ...
            magma_sgetmatrix( n, n, dSA, 0, ldda, SR, lda, opts.queue );
            
            if ( opts.verbose ) {
                printf( "A=  " );  magma_dprint( n, n, A,  lda );
                printf( "SA= " );  magma_sprint( n, n, SA, lda );
                printf( "dA= " );  magma_dprint_gpu( n, n, dA,  0, ldda, opts.queue );
                printf( "dSA=" );  magma_sprint_gpu( n, n, dSA, 0, ldda, opts.queue );
            }
            ...
            gpu_time = magma_sync_wtime( opts.queue );
            magmablas_slat2d( uplo[iuplo], n, dSA, 0, ldda, dA, 0, ldda, opts.queue, &info );
            gpu_time = magma_sync_wtime( opts.queue ) - gpu_time;
            gpu_perf = gbytes / gpu_time;
            if (info != 0)
            ...
            magma_dgetmatrix( n, n, dA, 0, ldda, R, lda, opts.queue );
