/*
    -- MAGMA (version 1.1) --
       ...
       @generated from testing/testing_zhemv.cpp, normal z -> c, Tue Jun 18 16:14:24 2019
...
int main(int argc, char **argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magmablas_claset( MagmaFull, ldda,   N, MAGMA_C_NAN, MAGMA_C_NAN, dA,    0, ldda,   opts.queue );
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_csetmatrix( N, N, A, lda, dA, 0, ldda, opts.queue );
            ...
            magma_cgetvector( N, dY, 0, incy, Ycublas, incy, opts.queue );
