    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            /* =====================================================================
               ...
               =================================================================== */
            magma_zsetmatrix( An, Ak, h_A, lda, d_A, 0, ldda, opts.queue );
            magma_zsetmatrix( Bn, Bk, h_B, ldb, d_B, 0, lddb, opts.queue );
            magma_zsetmatrix( N, N, h_C, ldc, d_C, 0, lddc, opts.queue );
            ...
            magma_zgetmatrix( N, N, d_C, 0, lddc, h_Ccublas, ldc, opts.queue );
