/*
    -- MAGMA (version 1.1) --
       ...
       @generated from testing/testing_zhemv.cpp, normal z -> d, Tue Jun 18 16:14:24 2019
...
int main(int argc, char **argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            magmablas_dlaset( MagmaFull, ldda,   N, MAGMA_D_NAN, MAGMA_D_NAN, dA,    0, ldda,   opts.queue );
            ...
            magma_dgetvector( N, dY, 0, incy, Ycublas, incy, opts.queue );
