    ...
    magma_queue_t queue )
{
    ...
    size_t buffer_origin[3] = { (size_t) dB_offset*elemSize, 0, 0 };
    size_t host_orig[3]     = { (size_t) 0, 0, 0 };
    size_t region[3]        = { (size_t) m*elemSize, (size_t) n, 1 };
    ...
    magma_queue_t queue )
{
    ...
    size_t buffer_origin[3] = { (size_t) dA_offset*elemSize, 0, 0 };
    size_t host_orig[3]     = { (size_t) 0, 0, 0 };
    size_t region[3]        = { (size_t) m*elemSize, (size_t) n, 1 };
    ...
    magma_queue_t queue )
{
    ...
    size_t src_origin[3] = { (size_t) dA_offset*elemSize, 0, 0 };
    size_t dst_orig[3]   = { (size_t) dB_offset*elemSize, 0, 0 };
    size_t region[3]     = { (size_t) m*elemSize, (size_t) n, 1 };
