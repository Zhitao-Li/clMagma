/*
    -- MAGMA (version 1.1) --
       ...
       @generated from src/zunmqr.cpp, normal z -> c, Tue Jun 18 16:14:17 2019
    ...
    magma_int_t *info)
{
    ...
    #define dV(i_,j_)  dV,    (dV_offset + (i_) + (j_)*nq_i)
    ...
    *info = 0;
    ...
    if (*info == 0) {
        nb = magma_get_cgeqrf_nb( min( m, n ));
        lwkopt = max(1,nw)*nb;
