/*
   ...
   @generated from src/zgeqrf_msub.cpp, normal z -> s, Tue Jun 18 16:14:17 2019
    ...
    *info = 0;
    ...
    if (nb >= nbmin && nb < k && nx < k) {
        ...
        for (i = 0; i < k-nx; i += nb) {
            ...
            magma_spanel_to_q( MagmaUpper, ib, hwrk(i), ldwork, lhwrk+ib*ib );
            ...
            if (i + ib < n) {
                 if (i+nb < k-nx) {
                    ...
                    /* Restore the panel */
                    magma_sq_to_panel( MagmaUpper, ib, hwrk(i), ldwork, lhwrk+ib*ib );
                } else {
