/*
   ...
   @generated from src/zpotri_gpu.cpp, normal z -> c, Tue Jun 18 16:14:15 2019
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    magma_ctrtri_gpu( uplo, MagmaNonUnit, n, dA(0,0), ldda, queues, info );
    if ( *info == 0 ) {
        /* Form inv(U) * inv(U)**T or inv(L)**T * inv(L) */
        magma_clauum_gpu( uplo, n, dA(0,0), ldda, queues[0], info );
    }
