/*
    -- clMAGMA (version 1.1) --
       ...
       @generated from src/zhetrf_nopiv.cpp, normal z -> c, Tue Jun 18 16:14:17 2019
*/
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        for (j=0; j<n; j+=nb) {
            ...
            magma_csetmatrix_async(j+jb, jb, A(0, j), lda, dA(0, j), ldda, queues[0], NULL);
            trace_gpu_end( 0, 0 );
        }
        ...
        for (j=0; j<n; j += nb) {
            ...
            if ( j!=0) {
                ...
                magma_cgetmatrix_async(jb, jb, dA(j, j), ldda, A(j,j), lda, queues[0], NULL);
            }
            trace_gpu_end( 0, 0 );
            ...
            trace_gpu_start( 0, 0, "set", "set" );
            magma_csetmatrix_async(jb, jb, A(j, j), lda, dA(j, j), ldda, queues[0], NULL);
            trace_gpu_end( 0, 0 );
            
            // copy j-th column of U back to CPU
            trace_gpu_start( 0, 1, "get", "get" );
            magma_cgetmatrix_async(j, jb, dA(0, j), ldda, A(0, j), lda, queues[1], NULL);
            trace_gpu_end( 0, 1 );
            ...
            if ( (j+jb) < n) {
                ...
                magma_ccopymatrix( jb, n-j-jb, dA( j, j+jb ), ldda, 
        ...
        for (j=0; j<n; j+=nb) {
            jb = min(nb, (n-j));
            trace_gpu_start( 0, 0, "set", "set" );
            magma_csetmatrix_async((n-j), jb, A(j, j), lda, dA(j, j), ldda, queues[0], NULL);
            trace_gpu_end( 0, 0 );
        }
        ...
        for (j=0; j<n; j+=nb) {
            ...
            trace_gpu_start( 0, 1, "get", "get" );
            magma_cgetmatrix_async(jb, j, dA(j, 0), ldda, A(j, 0), lda, queues[1], NULL);
            trace_gpu_end( 0, 1 ); 
            ...
            if ( (j+jb) < n) {
                ...
                magma_ccopymatrix( n-j-jb,jb, dA( j+jb, j ), ldda, 
