/*
    -- MAGMA (version 1.1) --
       ...
       @generated from src/zlahru.cpp, normal z -> s, Tue Jun 18 16:14:17 2019
       @author Stan Tomov
       @author Mark Gates
*/
    ...
    magma_queue_t queue )
{
    ...
    #define  dY(i_,j_) dY, ((i_) + (j_)*ldda + dY_offset)
    #define  dV(i_,j_) dV, ((i_) + (j_)*ldda + dV_offset)
    #define dYm(i_,j_) dV, ((i_) + (j_)*ldda + dV_offset + ihi - k)
    #define  dT(i_,j_) dT, ((i_) + (j_)*ldda + dT_offset)
