/*
    -- clMAGMA (version 0.1) --
       ...
       @generated from src/zhetrd.cpp, normal z -> c, Tue Jun 18 16:14:17 2019
...
/*  -- clMAGMA (version 0.1) --
    ...
    *info = 0;
    ...
    if (upper) {
        ...
        lapackf77_chetd2( lapack_uplo_const(uplo), &kk, A(0, 0), &lda, d, e, tau, &iinfo);
    }
    else {
        /* Copy the matrix to the GPU */
        if (1 <= n-nx)
        ...
        i_n = n-i;
        lapackf77_chetrd( lapack_uplo_const(uplo), &i_n, A(i, i), &lda, &d[i], &e[i],
