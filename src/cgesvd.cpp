/*
    -- MAGMA (version 1.1) --
       ...
       @author Stan Tomov
       @author Mark Gates
       @generated from src/zgesvd.cpp, normal z -> c, Tue Jun 18 16:14:18 2019
    ...
    if (m >= n) {
        ...
        if (m >= mnthr) {
            if (want_un) {
                ...
                lwork2 = lwork - iwork + 1;
                //printf( "path 1\n" );
                magma_cgebrd(n, n, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                ...
                if (lwork >= n*n + wrkbrd) {
                    ...
                    magma_cungqr2(m, n, n, A, lda, &work[itau], queue, &ierr);
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 2-a\n" );
                    magma_cgebrd(n, n, &work[ir], ldwrkr, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 2-b\n" );
                    magma_cgebrd(m, n, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                ...
                if (lwork >= n*n + wrkbrd) {
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 3-a\n" );
                    magma_cgebrd(n, n, VT, ldvt, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                ...
                if (want_vn) {
                    ...
                    if (lwork >= n*n + wrkbrd) {
                        ...
                        magma_cungqr2(m, n, n, U, ldu, &work[itau], queue, &ierr);
                    ...
                    if (lwork >= 2*n*n + wrkbrd) {
                        ...
                        lwork2 = lwork - iwork + 1;
                        //printf( "path 5-a\n" );
                        magma_cgebrd(n, n, &work[iu], ldwrku, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                ...
                if (want_vn) {
                    ...
                    if (lwork >= n*n + max(n + m, wrkbrd)) {
                        ...
                        magma_cungqr2(m, m, n, U, ldu, &work[itau], queue, &ierr);
        ...
        if (n >= mnthr) {
            if (want_vn) {
                ...
                lwork2 = lwork - iwork + 1;
                //printf( "path 1t\n" );
                magma_cgebrd(m, m, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                ...
                if (lwork >= m*m + wrkbrd) {
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 2t-a\n" );
                    magma_cgebrd(m, m, &work[ir], ldwrkr, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                ...
                if (lwork >= m*m + wrkbrd) {
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 3t-a\n" );
                    magma_cgebrd(m, m, U, ldu, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                ...
                if (want_un) {
                    ...
                    if (lwork >= 2*m*m + wrkbrd) {
                        ...
                        lwork2 = lwork - iwork + 1;
                        //printf( "path 5t-a\n" );
                        magma_cgebrd(m, m, &work[iu], ldwrku, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
