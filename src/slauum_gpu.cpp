/*
    -- clMAGMA (version 0.4) --
       ...
       @generated from src/zlauum_gpu.cpp, normal z -> s, Tue Jun 18 16:14:15 2019
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if (nb <= 1 || nb >= n) {
        magma_sgetmatrix( n, n, dA(0,0), ldda, work, n, queue );
        lapackf77_slauum( uplo_, &n, work, &n, info );
        magma_ssetmatrix( n, n, work, n, dA(0,0), ldda, queue );
    }
    else {
        if (upper) {
