/*
     -- clMAGMA (version 0.1) --
       ...
       @author Stan Tomov
       @author Mark Gates
        @generated from src/zpotrf_gpu.cpp, normal z -> d, Tue Jun 18 16:14:15 2019
*/
    ...
    magma_int_t*   info )
{
    ...
    *info = 0;
    ...
    if ((nb <= 1) || (nb >= n)) {
        // Use unblocked code
        magma_dgetmatrix_async( n, n, dA(0,0), ldda, work, n, queue, NULL );
        magma_queue_sync( queue );
        lapackf77_dpotrf( uplo_, &n, work, &n, info );
        magma_dsetmatrix_async( n, n, work, n, dA(0,0), ldda, queue, NULL );
    }
    else {
        // Use blocked code.
        if (upper) {
