    ...
    if (m >= n) {
        ...
        if (m >= mnthr) {
            if (wantqn) {
                ...
                #else
                magma_dgebrd(n, n, A(1,1), lda, s, &work[ie], &work[itauq], &work[itaup], &work[nwork], lnwork, queue, &ierr);
                #endif
                nwork = ie + n;
                ...
                #else
                magma_dgebrd(n, n, &work[ir], ldwrkr, s, &work[ie], &work[itauq], &work[itaup], &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_dormbr(MagmaQ, MagmaLeft,  MagmaNoTrans, n, n, n, &work[ir], ldwrkr, &work[itauq], &work[iu], n,    &work[nwork], lnwork, queue, &ierr);
                magma_dormbr(MagmaP, MagmaRight, MagmaTrans,   n, n, n, &work[ir], ldwrkr, &work[itaup], VT,        ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                lapackf77_dormbr("P", "R", "T", &n, &n, &n, &work[ir], &ldwrkr, &work[itaup], VT, &ldvt, &work[nwork], &lnwork, &ierr);
                #else
                magma_dormbr(MagmaQ, MagmaLeft,  MagmaNoTrans, n, n, n, &work[ir], ldwrkr, &work[itauq], U,  ldu,  &work[nwork], lnwork, queue, &ierr);
                magma_dormbr(MagmaP, MagmaRight, MagmaTrans,   n, n, n, &work[ir], ldwrkr, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_dormbr(MagmaQ, MagmaLeft,  MagmaNoTrans, n, n, n, A(1,1), lda, &work[itauq], &work[iu], ldwrku, &work[nwork], lnwork, queue, &ierr);
                magma_dormbr(MagmaP, MagmaRight, MagmaTrans,   n, n, n, A(1,1), lda, &work[itaup], VT,        ldvt,   &work[nwork], lnwork, queue, &ierr);
                #endif
            ...
            #else
            magma_dgebrd(m, n, A(1,1), lda, s, &work[ie], &work[itauq], &work[itaup], &work[nwork], lnwork, queue, &ierr);
            #endif
            ...
            if (wantqn) {
                ...
                if (lwork >= m*n + 3*n + bdspac) {
                    ...
                    #else
                    magma_dormbr(MagmaQ, MagmaLeft, MagmaNoTrans, m, n, n, A(1,1), lda, &work[itauq], &work[iu], ldwrku, &work[nwork], lnwork, queue, &ierr);
                    #endif
                ...
                lapackf77_dormbr("P", "R", "T", &n, &n, &n, A(1,1), &lda, &work[itaup], VT, &ldvt, &work[nwork], &lnwork, &ierr);
                #else
                magma_dormbr(MagmaQ, MagmaLeft,  MagmaNoTrans, m, n, n, A(1,1), lda, &work[itauq], U,  ldu,  &work[nwork], lnwork, queue, &ierr);
                magma_dormbr(MagmaP, MagmaRight, MagmaTrans,   n, n, n, A(1,1), lda, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
            }
            else if (wantqa) {
                ...
                #else
                magma_dormbr(MagmaQ, MagmaLeft,  MagmaNoTrans, m, m, n, A(1,1), lda, &work[itauq], U,  ldu,  &work[nwork], lnwork, queue, &ierr);
                magma_dormbr(MagmaP, MagmaRight, MagmaTrans,   n, n, m, A(1,1), lda, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
            }
        }
    }
        ...
        if (n >= mnthr) {
            if (wantqn) {
                ...
                #else
                magma_dgebrd(m, m, A(1,1), lda, s, &work[ie], &work[itauq], &work[itaup], &work[nwork], lnwork, queue, &ierr);
                #endif
                nwork = ie + m;
                ...
                #else
                magma_dgebrd(m, m, &work[il], ldwrkl, s, &work[ie], &work[itauq], &work[itaup], &work[nwork], lnwork,queue, &ierr);
                #endif
                ...
                #else
                magma_dormbr(MagmaQ, MagmaLeft,  MagmaNoTrans, m, m, m, &work[il], ldwrkl, &work[itauq], U,          ldu, &work[nwork], lnwork, queue, &ierr);
                magma_dormbr(MagmaP, MagmaRight, MagmaTrans,   m, m, m, &work[il], ldwrkl, &work[itaup], &work[ivt], m,   &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_dormbr(MagmaQ, MagmaLeft,  MagmaNoTrans, m, m, m, &work[il], ldwrkl, &work[itauq], U,  ldu,  &work[nwork], lnwork, queue, &ierr);
                magma_dormbr(MagmaP, MagmaRight, MagmaTrans,   m, m, m, &work[il], ldwrkl, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_dormbr(MagmaQ, MagmaLeft,  MagmaNoTrans, m, m, m, A(1,1), lda, &work[itauq], U,          ldu,    &work[nwork], lnwork, queue, &ierr);
                magma_dormbr(MagmaP, MagmaRight, MagmaTrans,   m, m, m, A(1,1), lda, &work[itaup], &work[ivt], ldwkvt, &work[nwork], lnwork, queue, &ierr);
                #endif
            ...
            if (wantqn) {
                ...
                if (lwork >= m*n + 3*m + bdspac) {
                    ...
                    #else
                    magma_dormbr(MagmaP, MagmaRight, MagmaTrans, m, n, m, A(1,1), lda, &work[itaup], &work[ivt], ldwkvt, &work[nwork], lnwork, queue, &ierr);
                    #endif
                ...
                #else
                magma_dormbr(MagmaQ, MagmaLeft,  MagmaNoTrans, m, m, n, A(1,1), lda, &work[itauq], U,  ldu,  &work[nwork], lnwork, queue, &ierr);
                magma_dormbr(MagmaP, MagmaRight, MagmaTrans,   m, n, m, A(1,1), lda, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
            }
            else if (wantqa) {
                /* Path 5ta (N > M, JOBZ='A') */
