/*
    -- MAGMA (version 1.1) --
       ...
       @author Stan Tomov
       @author Mark Gates
       @generated from src/dgesvd.cpp, normal d -> s, Tue Jun 18 16:14:18 2019
        ...
        if (m >= mnthr) {
            if (want_un) {
                ...
                magma_sgebrd(n, n, A, lda, s, &work[ie],
                             &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                #endif
                ...
                if (lwork >= n*n + max(wrkbrd, bdspac)) {
                    ...
                    #else
                    magma_sorgqr2(m, n, n, A, lda, &work[itau], queue, &ierr);
                    #endif
                ...
                if (want_vn) {
                    ...
                    if (lwork >= n*n + max(wrkbrd, bdspac)) {
                        ...
                        lapackf77_sorgqr(&m, &n, &n, U, &ldu,
                                         &work[itau], &work[iwork], &lwork2, &ierr);
                        #else
                        magma_sorgqr2(m, n, n, U, ldu, &work[itau], queue, &ierr);
                        #endif
                ...
                if (want_vn) {
                    ...
                    if (lwork >= n*n + max( max(n + m, wrkbrd), bdspac)) {
                        ...
                        lapackf77_sorgqr(&m, &m, &n, U, &ldu,
                                         &work[itau], &work[iwork], &lwork2, &ierr);
                        #else
                        magma_sorgqr2(m, m, n, U, ldu, &work[itau], queue, &ierr);
                        #endif
