/*  -- clMAGMA (version 0.4) --
    ...
    @generated from src/dlaex3.cpp, normal d -> s, Tue Jun 18 16:14:17 2019
*/
    ...
    magma_int_t *info )
{
    ...
    #define  dQ(i_,j_) dQ,  ( dq_offset + (i_) + (j_)*lddq)
    #define dQ2(i_,j_) dQ2, (dq2_offset + (i_) + (j_)*lddq)
    #define  dS(i_,j_) dS,  ( ds_offset + (i_) + (j_)*lddq)
    ...
    magmaFloat_ptr dQ2 = dwork; size_t dq2_offset = 0;
    magmaFloat_ptr dS  = dQ2;   size_t ds_offset  = dq2_offset + n*lddq;
    magmaFloat_ptr dQ  = dS;    size_t dq_offset  = ds_offset  + n*lddq;
    ...
    *info = 0;
    ...
    magma_ssetvector_async( lq2, Q2, 1, dQ2(0,0), 1, queue, NULL );
