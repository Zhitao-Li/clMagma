/*
    -- clMAGMA (version 0.1) --
       ...
       @generated from src/zposv.cpp, normal z -> d, Tue Jun 18 16:14:16 2019
...
/*  -- clMAGMA (version 0.1) --
    ...
    *info = 0;
    ...
    magma_dpotrf2_gpu( uplo, n, dA, 0, ldda, queues, info );
    ...
    if ( *info == 0 ) {
        ...
        magma_dpotrs_gpu( uplo, n, nrhs, dA, 0, ldda, dB, 0, lddb, queues[0], info );
...
CPU_INTERFACE:
    ...
    magma_dpotrf( uplo, n, A, lda, queues, info );
    if ( *info == 0 ) {
