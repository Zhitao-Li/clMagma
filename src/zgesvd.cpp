    ...
    if (m >= n) {
        ...
        if (m >= mnthr) {
            if (want_un) {
                ...
                lwork2 = lwork - iwork + 1;
                //printf( "path 1\n" );
                magma_zgebrd(n, n, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                ...
                if (lwork >= n*n + wrkbrd) {
                    ...
                    magma_zungqr2(m, n, n, A, lda, &work[itau], queue, &ierr);
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 2-a\n" );
                    magma_zgebrd(n, n, &work[ir], ldwrkr, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 2-b\n" );
                    magma_zgebrd(m, n, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                ...
                if (lwork >= n*n + wrkbrd) {
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 3-a\n" );
                    magma_zgebrd(n, n, VT, ldvt, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                ...
                if (want_vn) {
                    ...
                    if (lwork >= n*n + wrkbrd) {
                        ...
                        magma_zungqr2(m, n, n, U, ldu, &work[itau], queue, &ierr);
                    ...
                    if (lwork >= 2*n*n + wrkbrd) {
                        ...
                        lwork2 = lwork - iwork + 1;
                        //printf( "path 5-a\n" );
                        magma_zgebrd(n, n, &work[iu], ldwrku, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                ...
                if (want_vn) {
                    ...
                    if (lwork >= n*n + max(n + m, wrkbrd)) {
                        ...
                        magma_zungqr2(m, m, n, U, ldu, &work[itau], queue, &ierr);
        ...
        if (n >= mnthr) {
            if (want_vn) {
                ...
                lwork2 = lwork - iwork + 1;
                //printf( "path 1t\n" );
                magma_zgebrd(m, m, A, lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                ...
                if (lwork >= m*m + wrkbrd) {
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 2t-a\n" );
                    magma_zgebrd(m, m, &work[ir], ldwrkr, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                ...
                if (lwork >= m*m + wrkbrd) {
                    ...
                    lwork2 = lwork - iwork + 1;
                    //printf( "path 3t-a\n" );
                    magma_zgebrd(m, m, U, ldu, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
                ...
                if (want_un) {
                    ...
                    if (lwork >= 2*m*m + wrkbrd) {
                        ...
                        lwork2 = lwork - iwork + 1;
                        //printf( "path 5t-a\n" );
                        magma_zgebrd(m, m, &work[iu], ldwrku, s, &rwork[ie], &work[itauq], &work[itaup], &work[iwork], lwork2, queue, &ierr);
