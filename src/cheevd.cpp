/*
    -- clMAGMA (version 0.4) --
       ...
       @generated from src/zheevd.cpp, normal z -> c, Tue Jun 18 16:14:17 2019
...
/*  -- clMAGMA (version 0.4) --
    ...
    *info = 0;
    ...
    anrm = lapackf77_clanhe("M", lapack_uplo_const(uplo), &n, a, &lda, rwork);
    iscale = 0;
    if (anrm > 0. && anrm < rmin) {
        iscale = 1;
        sigma = rmin / anrm;
    ...
    if (iscale == 1) {
        lapackf77_clascl( lapack_uplo_const(uplo), &izero, &izero, &d_one, &sigma, &n, &n, a,
                          &lda, info);
    }
