/*
    -- clMAGMA (version 0.1) --
       ...
       @generated from src/zgesv.cpp, normal z -> c, Tue Jun 18 16:14:16 2019
...
/*  -- clMAGMA (version 0.1) --
    ...
    *info = 0;
    ...
    magma_cgetrf2_gpu( n, n, dA, 0, ldda, ipiv, queues, info );
    ...
    if ( *info == 0 ) {
        ...
        magma_cgetrs_gpu( MagmaNoTrans, n, nrhs, dA, 0, ldda, ipiv, dB, 0, lddb, queues[0], info);
...
CPU_INTERFACE:
    ...
    magma_cgetrf( n, n, A, lda, ipiv, queues, info );
    if ( *info == 0 ) {
