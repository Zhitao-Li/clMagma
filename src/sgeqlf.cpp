/*
    -- MAGMA (version 1.1) --
       ...
       @generated from src/zgeqlf.cpp, normal z -> s, Tue Jun 18 16:14:17 2019
    ...
    if ( (nb > 1) && (nb < k) ) {
        ...
        for (i = k - kk + ki; i >= k -kk; i -= nb) {
            ...
            if (cols > 0) {
                ...
                magma_ssetmatrix( ib, ib, work, ib, dwork(0), lddwork, queues[0] );
        ...
        magma_sgetmatrix( m, nu, dA(0,0), ldda, A(0,0), lda, queues[0] );
    } else {
        mu = m;
        nu = n;
    }
