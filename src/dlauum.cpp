/*
    -- MAGMA (version 1.1) --
       ...
       @generated from src/zlauum.cpp, normal z -> d, Tue Jun 18 16:14:16 2019
        ...
        if (upper) {
            ...
            for (i=0; i < n; i += nb) {
                ...
                magma_dsetmatrix_async( ib, ib,
                                        A(i,i),   lda,
                                        dA(i,i), ldda, queues[1], NULL );

                magma_dsetmatrix_async( ib, (n-i-ib),
                                        A(i,i+ib),  lda,
                                        dA(i,i+ib), ldda, queues[0], NULL );
                ...
                magma_dsetmatrix_async( ib, ib,
                                        A(i,i),  lda,
                                        dA(i,i), ldda, queues[0], NULL );

                if (i+ib < n) {
                    magma_dgemm( MagmaNoTrans, MagmaConjTrans,
                                 i, ib, (n-i-ib), c_one,
                                 dA(0,i+ib), ldda,
                                 dA(i,i+ib), ldda, c_one,
                                 dA(0,i),    ldda, queues[0] );
