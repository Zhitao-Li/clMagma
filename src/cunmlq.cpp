/*
    -- clMAGMA (version 1.1) --
       ...
       @generated from src/zunmlq.cpp, normal z -> c, Tue Jun 18 16:14:17 2019
    ...
    magma_int_t *info)
{
    ...
    #define dV(i_,j_) dV, (dV_offset + (i_) + (j_)*ib)
    #define dT(i_,j_) dT, (dT_offset + (i_) + (j_)*ib)
    ...
    *info = 0;
    ...
    if (nb >= k) {
        ...
        size_t dwork_offset, dV_offset, dT_offset, dC_offset;
        dwork_offset = 0;
        dV = dwork;  dV_offset = dwork_offset + nw*nb;
        dT = dV;     dT_offset = dV_offset    + nq*nb;
        dC = dT;     dC_offset = dT_offset    + nb*nb;
