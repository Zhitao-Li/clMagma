/*
    -- clMAGMA (version 1.1) --
       ...
       @author Mark Gates
       @generated from src/zgesdd.cpp, normal z -> c, Tue Jun 18 16:14:18 2019
    ...
    if (m >= n) {
        ...
        if (m >= mnthr1) {
            if (wantqn) {
                ...
                #else
                magma_cgebrd(n, n, A(1,1), lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[nwork], lnwork, queue, &ierr);
                #endif
                nrwork = ie + n;
                ...
                #else
                magma_cgebrd(n, n, &work[ir], ldwrkr, s, &rwork[ie], &work[itauq], &work[itaup], &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_cunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, n, n, n, &work[ir], ldwrkr, &work[itauq], &work[iu], ldwrku, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_cunmbr(MagmaP, MagmaRight, MagmaConjTrans, n, n, n, &work[ir], ldwrkr, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_cunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, n, n, n, &work[ir], ldwrkr, &work[itauq], U, ldu, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_cunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, n, n, n, A(1,1), lda, &work[itauq], &work[iu], ldwrku, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_cunmbr(MagmaP, MagmaRight, MagmaConjTrans, n, n, n, A(1,1), lda, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
            ...
            #else
            magma_cgebrd(m, n, A(1,1), lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[nwork], lnwork, queue, &ierr);
            #endif
            ...
            if (wantqn) {
                ...
                if (lwork >= m*n + 3*n) {
                    ...
                    #else
                    magma_cunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, m, n, n, A(1,1), lda, &work[itauq], &work[iu], ldwrku, &work[nwork], lnwork, queue, &ierr);
                    #endif
                ...
                #else
                magma_cunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, m, n, n, A(1,1), lda, &work[itauq], U, ldu, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_cunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, m, m, n, A(1,1), lda, &work[itauq], U, ldu, &work[nwork], lnwork, queue, &ierr);
                #endif
        ...
        if (n >= mnthr1) {
            if (wantqn) {
                ...
                #else
                magma_cgebrd(m, m, A(1,1), lda, s, &rwork[ie], &work[itauq], &work[itaup], &work[nwork], lnwork, queue, &ierr);
                #endif
                nrwork = ie + m;
                ...
                #else
                magma_cgebrd(m, m, &work[il], ldwrkl, s, &rwork[ie], &work[itauq], &work[itaup], &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_cunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, m, m, m, &work[il], ldwrkl, &work[itauq], U, ldu, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_cunmbr(MagmaP, MagmaRight, MagmaConjTrans, m, m, m, &work[il], ldwrkl, &work[itaup], &work[ivt], ldwkvt, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_cunmbr(MagmaP, MagmaRight, MagmaConjTrans, m, m, m, &work[il], ldwrkl, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_cunmbr(MagmaQ, MagmaLeft, MagmaNoTrans, m, m, m, A(1,1), lda, &work[itauq], U, ldu, &work[nwork], lnwork, queue, &ierr);
                #endif
                ...
                #else
                magma_cunmbr(MagmaP, MagmaRight, MagmaConjTrans, m, m, m, A(1,1), lda, &work[itaup], &work[ivt], ldwkvt, &work[nwork], lnwork, queue, &ierr);
                #endif
            ...
            if (wantqn) {
                ...
                if (lwork >= m*n + 3*m) {
                    ...
                    #else
                    magma_cunmbr(MagmaP, MagmaRight, MagmaConjTrans, m, n, m, A(1,1), lda, &work[itaup], &work[ivt], ldwkvt, &work[nwork], lnwork, queue, &ierr);
                    #endif
                ...
                #else
                magma_cunmbr(MagmaP, MagmaRight, MagmaConjTrans, m, n, m, A(1,1), lda, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
            }
            else {
                /* Path 6ta (N >= M, JOBZ=A) */
                ...
                #else
                magma_cunmbr(MagmaP, MagmaRight, MagmaConjTrans, n, n, m, A(1,1), lda, &work[itaup], VT, ldvt, &work[nwork], lnwork, queue, &ierr);
                #endif
            }
        }
    }
