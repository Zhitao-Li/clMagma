/*
    -- MAGMA (version 1.1) --
       ...
       @generated from src/zgelqf.cpp, normal z -> s, Tue Jun 18 16:14:17 2019
    ...
    magma_int_t *info)
{
    ...
    *info = 0;
    ...
    if (maxdim*maxdim < 2*maxm*maxn) {
        ...
        magmablas_stranspose_inplace( lddat, dAT(0,0), lddat, queues[0] );
    }
    else {
    ...
    // factor QR
    magma_sgeqrf2_gpu(n, m, dAT(0,0), lddat, tau, queues, &iinfo);
